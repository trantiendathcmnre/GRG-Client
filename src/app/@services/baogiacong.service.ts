...
export class BaoGiaCongService {
  ...
  getAll() {
    // this.createHeader();
    const url = this.apisService.baoGiaCong.getAll.url;
    return this.http.get(url, this.headerOptions).map(response => response.json());
  }

  get(id) {
    // this.createHeader();
    const url = this.apisService.baoGiaCong.get.url + id;
    return this.http.get(url, this.headerOptions).map(response => response.json());
  }

  add(data) {
    // this.createHeader();
    const url = this.apisService.baoGiaCong.add.url;
    return this.http.post(url, data, this.headerOptions).map(response => response.json());
  }

  update(data) {
    // this.createHeader();
    const url = this.apisService.baoGiaCong.update.url;
    return this.http.put(url, data, this.headerOptions).map(response => response.json());
  }

  delete(id) {
    // this.createHeader();
    const url = this.apisService.baoGiaCong.delete.url + id;
    return this.http.delete(url, this.headerOptions).map(response => response.json());
  }

  createMabaoGiaCong() {
    // this.createHeader();
    const url = this.apisService.baoGiaCong.getMaBaoGiaCong.url;
    return this.http.get(url, this.headerOptions).map(response => response.json());
  }
  // createHeader()
  // {
